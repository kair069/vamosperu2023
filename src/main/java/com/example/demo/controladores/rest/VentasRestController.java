...
import com.example.demo.servicios.VentasServicios;
...
public class VentasRestController {
    ...
    public ResponseEntity<Object> buscarTodo()	{
        List<Ventas> listaClientes = servicio.buscarTodo();
    ...
    public ResponseEntity<Object> buscarPorId(@PathVariable("id") int id) {
        Ventas funcion = servicio.buscarPorId(id);
        if (funcion == null)
    ...
    public  ResponseEntity <Object> crear (@RequestBody Ventas funcion){
    ...
    public ResponseEntity<Object> actualizar(@PathVariable("id") int id, @RequestBody Ventas funcion){
