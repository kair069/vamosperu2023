...
import com.example.demo.servicios.LoginServicios;
...
public class LoginRestController {
    @Autowired
    private LoginServicios servicio;

    @GetMapping
    public ResponseEntity<Object> buscarTodo()	{
        List<Login> listaClientes = servicio.buscarTodo();
    ...
    public ResponseEntity<Object> buscarPorId(@PathVariable("id") int id) {
        Login funcion = servicio.buscarPorId(id);
        if (funcion == null)
    ...
    public  ResponseEntity <Object> crear (@RequestBody Login funcion){
    ...
    public ResponseEntity<Object> actualizar(@PathVariable("id") int id, @RequestBody Login funcion){
