...
import com.example.demo.servicios.PedidosServicios;
...
public class PedidosRestController {
    @Autowired
    private PedidosServicios servicio;

    @GetMapping
    public ResponseEntity<Object> buscarTodo()	{
        List<Pedido> listaClientes = servicio.buscarTodo();
    ...
    public ResponseEntity<Object> buscarPorId(@PathVariable("id") int id) {
        Pedido funcion = servicio.buscarPorId(id);
        if (funcion == null)
    ...
    public  ResponseEntity <Object> crear (@RequestBody Pedido funcion){
    ...
    public ResponseEntity<Object> actualizar(@PathVariable("id") int id, @RequestBody Pedido funcion){
